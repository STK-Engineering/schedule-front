...
export default function Edit() {
  ...
  useEffect(() => {
    ...
    setLeaveType(params.leaveType ?? "연차");
        ...
        >
          ...
          >
            ...
            {["신청인", "부서장", "대표"].map((item) => (
              <View
                key={item}
                style={{ width: 80, borderLeftWidth: 1, borderColor: "#333" }}
              >
                <View
                  style={{
                    height: 22,
          ...
          />
          <FormRow label="사용일" value={`${diffDay}일`} />
...
const styles = StyleSheet.create({
  ...
  rightBox: { width: "50%", padding: 20 },

  leaveTypeRow: { flexDirection: "row", marginTop: 10 },
  leaveTypeButton: {
    paddingVertical: 8,
  ...
  textArea1: { height: 40, width: "100%" },
  textArea2: { height: 200, width: "100%" },
